...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/sprites/spritesheet.xml");
		types.push (AssetType.TEXT);
	...
	public static function main () {
		...
		#if js
		#if munit
		flash.Lib.embed (null, 700, 700, "BBBBBB");
		#end
		#else
		create ();
		#end
	...
	public static function start ():Void {
		...
		for (methodName in Type.getClassFields (com.fs.kiwi.Main)) {
		...
		if (hasMain) {
			...
			Reflect.callMethod (com.fs.kiwi.Main, Reflect.field (com.fs.kiwi.Main, "main"), []);
...
@:keep class DocumentClass extends com.fs.kiwi.Main {}
